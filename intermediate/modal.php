...
<?php 
    //Sets variables
    $relpath= "../"; $title="Vi|Modal Editing"; $page="modal"; $imgpath="http://serenity.ist.rit.edu/~iste240t04/240/final/assets/media/images/";
?>
...
<?php include "../assets/inc/navigation.php" ?>
  <main>
    <div class="content" id="home"><h1>VIable</h1>
        <p><b>user@localhost~:$</b> $page = intermediate/<?php echo $page ?></p>
        <p>
